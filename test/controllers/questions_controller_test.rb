...
class QuestionsControllerTest < ActionController::TestCase
  ...
  test "can just watch, can not create, update and destroy before login" do
    ...
    assert_redirected_to login_url
    post :create, params: { question: { title: "haha", content: "ok" } }
    assert_redirected_to login_url
    patch :update, params: { id: 1, question: { title: "haha", content: "ok" } }
    assert_redirected_to login_url
  end
  ...
  test "user can crud" do
    ...
    patch :update, params: { id: 1, question: { title: "hah", content: "okl", issolved: true } }
  ...
  test "invalid edit by student" do
    log_in_as @user4
    patch :update, params: { id: 1, question: { title: "", content: "okl", issolved: true } }
    assert_equal @question.title, "question"
    assert_template 'questions/edit'
    get :edit, params: { id: 2 }
    assert_redirected_to root_url
    patch :update, params: { id: 2, question: { title: "hah", content: "okl", issolved: true } }
    assert_redirected_to root_url
  end
